...
if (isset($_SESSION['id']) && isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($result['count'] > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO event (nama, tanggalmulai, tanggalselesai, status, waktu) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param('sssss', $nama, $tanggalmulai, $tanggalselesai, $status, $waktu);
            $stmt->execute();
            $stmt->close();
        }
                ...
                <form method="POST">
                    <div class="form-container">
                        <div class="form-items single">
                            ...
                            <input type="text" name="nama" placeholder="Masukkan Nama Event" required>
                        </div>
                    </div>
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-items">
                            ...
                            <input type="time" name="waktu" id="waktu" placeholder="Masukkan Waktu Masuk..." required
                                disabled>
                        </div>
