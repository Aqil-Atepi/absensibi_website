...
<body>
  <div class="sidebar">
    <div class="nav-links">
      ...
      <a href="akun.php" class="<?= basename($_SERVER['PHP_SELF']) == 'siswa.php' ? 'active' : ''; ?>">
        <img src="../../assets/svg/user.svg" alt="Akun icon">
        <span>Akun</span>
      </a>

      <a href="jadwal.php" class="<?= basename($_SERVER['PHP_SELF']) == 'izin.php' ? 'active' : ''; ?>">
        <img src="../../assets/svg/calendar.svg" alt="Jadwal icon">
        <span>Jadwal</span>
      </a>

      <a href="kelas.php" class="<?= basename($_SERVER['PHP_SELF']) == 'izin.php' ? 'active' : ''; ?>">
        <img src="../../assets/svg/class.svg" alt="Kelas icon">
        <span>Kelas</span>
      </a>

      <a href="qrscan.php" class="<?= basename($_SERVER['PHP_SELF']) == 'izin.php' ? 'active' : ''; ?>">
        <img src="../../assets/svg/qr.svg" alt="QRScan icon">
        <span>Scan QR</span>
      </a>
