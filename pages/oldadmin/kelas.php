...
<head>
    ...
    <style>
        ...
        .kelas-data table tbody td {
            padding: 10px;
            font-size: 15px;
        }

        .kelas-data table tbody tr:hover {
